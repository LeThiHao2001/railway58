...
@ControllerAdvice
public class RestExceptHandler extends ResponseEntityExceptionHandler {
	...
	private String getMessage(String key) {
		...
		public ResponseEntity<Object> handleAll(Exception exception){
			...
			ErrorResponse reponse1= new ErrorResponse(message,detailMessage,null, code,moreInformation);
			
			return new ResponseEntity<>(reponse1,HttpStatus.INTERNAL_SERVER_ERROR);
...
//			
//			ErrorReponse1 reponse1 = new ErrorReponse1(message, detailMessage, null, code, moreInformation);
//			
//			return new ResponseEntity<>(reponse1, status);
//					
//		}
